...
local changeYourJob = {
  {name="Changes your job", colour=15, id=351, x=-266.94, y=-960.744, z=31.2231},
}

local jobs = {
  {name="Minor", id=4},
  {name="Taxi Driver", id=5},
}
...
Citizen.CreateThread(function()
  while true do
    ...
    if (IsNearJobs() == true) then
      drawTxt('Push ~g~H~s~ to access jobs menu',0,1,0.5,0.8,0.6,255,255,255,255)
